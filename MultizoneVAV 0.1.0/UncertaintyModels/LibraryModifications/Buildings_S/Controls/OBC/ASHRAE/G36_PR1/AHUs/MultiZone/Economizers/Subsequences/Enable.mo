within MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.Economizers.Subsequences;
block Enable // _99_01_benchmark
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_TOut(delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_TOutCut(delta=deltaMovAvg); // shiyab added
...
//  final parameter Modelica.SIunits.TemperatureDifference TOutHigLimCutHig = 0.5 // shiyab added
//  final parameter Modelica.SIunits.TemperatureDifference TOutHigLimCutHig = 0.2 // shiyab added

    "Hysteresis high limit cutoff";
  final parameter Real TOutHigLimCutLow = TOutHigLimCutHig - delTOutHis
//  final parameter Real TOutHigLimCutLow = -1.5 // shiyab added
//  final parameter Real TOutHigLimCutLow = -1.2 // shiyab added
...
/*  connect(TOut, add1.u1)
    annotation (Line(points={{-300,270},{-270,270},{-270,256},{-142,256}},color={0,0,127})); // shiyab removed */
  connect(TOut,movAvg_TOut.u); // shiyab added
  connect(movAvg_TOut.y,add1.u1); // shiyab added
/*  connect(TOutCut, add1.u2)
    annotation (Line(points={{-300,230},{-252,230},{-252,244},{-142,244}},color={0,0,127})); // shiyab removed */
  connect(TOutCut,movAvg_TOutCut.u); // shiyab added
  connect(movAvg_TOutCut.y,add1.u2); // shiyab added
