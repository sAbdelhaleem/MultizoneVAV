...
block TrimAndRespond "Block to inplement trim and respond logic" // _99_01_benchmark
...
/*  Buildings.Controls.OBC.CDL.Continuous.Min minInp // shiyab removed */
  Buildings.Controls.OBC.CDL.Continuous.Max minInp // shiyab added
