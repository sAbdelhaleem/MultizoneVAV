...
block OutsideAirFlow // _99_01_benchmark
...
//    quantity="ThermodynamicTemperature") = -1.3 // shiyab added
//    quantity="ThermodynamicTemperature") = -0.8 // shiyab added
...
//    quantity="ThermodynamicTemperature") = 0.8 // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_TDis[numZon](each delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VOutMinSet_flow_normalized(final unit="1")
...
/*  connect(TDis, add2.u2)
  ...
  connect(TDis[1],movAvg_TDis[1].u); // shiyab added
  connect(TDis[2],movAvg_TDis[2].u); // shiyab added
  connect(movAvg_TDis.y,add2.u2); // shiyab added
/*  connect(TZon, add2.u1)
  ...
  connect(movAvg_TZon.y,add2.u1); // shiyab added
