...
block ModeAndSetPoints "Output zone setpoint with operation mode selection" // _99_03_benchmark
  ...
  parameter Modelica.SIunits.Temperature freProEndVal=280.35
    ...
    annotation (Evaluate=true, Dialog(tab="Operation mode", group="Parameters"));
//  parameter Modelica.SIunits.Time warCooTim=1800 // shiyab
  parameter Modelica.SIunits.Time warCooTim=30*60 // shiyab
...
//  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.OperationMode opeModSel(
  MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.OperationMode opeModSel(
    final numZon=numZon,
