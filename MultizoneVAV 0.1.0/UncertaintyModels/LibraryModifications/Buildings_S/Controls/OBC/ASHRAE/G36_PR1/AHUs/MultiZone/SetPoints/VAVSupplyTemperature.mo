...
block VAVSupplyTemperature // _99_03_benchmark
  "Supply air temperature setpoint for multi zone system"

  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conIntCooDow( // shiyab added 190320
    final k=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.coolDown); // shiyab added 190320
  Buildings.Controls.OBC.CDL.Integers.Equal isCooDow; // shiyab added 190320

  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conIntSetUp( // shiyab added 190320
    final k=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.setUp); // shiyab added 190320
  Buildings.Controls.OBC.CDL.Integers.Equal isSetUp; // shiyab added 190320

  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conIntWarUp( // shiyab added 190423
    final k=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.warmUp); // shiyab added 190423
  Buildings.Controls.OBC.CDL.Integers.Equal isWarUp; // shiyab added 190423

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSupWarUp(k=(80+459.67)*5/9); // shiyab added 190423
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSupSetBac(k=(75+459.67)*5/9); // shiyab added 190423

  Buildings.Controls.OBC.CDL.Logical.Switch swi_isSetUp; // shiyab added 190320
  Buildings.Controls.OBC.CDL.Logical.Switch swi_isWarUp; // shiyab added 190423

//  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant maxSupTem(k=TSupMax); // shiyab added 190320
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant maxSupTem(k=(70+459.67)*5/9); // shiyab added 190320
...
/*  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.TrimAndRespond maxSupTemRes( // shiyab removed */
  MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.TrimAndRespond maxSupTemRes( // shiyab added
    final delTim=delTim,
    final iniSet=iniSet,
    final minSet=minSet,
    final maxSet=maxSet,
...
/*  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSupWarUpSetBac(k=35 + 273.15) // shiyab removed */
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSupWarUpSetBac(k=(85+459.67)*5/9) // shiyab added
...
equation
  connect(conIntCooDow.y, isCooDow.u1); // shiyab added 190320
  connect(uOpeMod, isCooDow.u2); // shiyab added 190320

  connect(conIntSetUp.y, isSetUp.u1); // shiyab added 190320
  connect(uOpeMod, isSetUp.u2); // shiyab added 190320

  connect(conIntWarUp.y, isWarUp.u1); // shiyab added 190423
  connect(uOpeMod, isWarUp.u2); // shiyab added 190423

  connect(TSupWarUp.y,swi_isWarUp.u1); // shiyab added 190423
  connect(isWarUp.y,swi_isWarUp.u2); // shiyab added 190423
  connect(TSupSetBac.y,swi_isWarUp.u3); // shiyab added 190423

  connect(maxSupTem.y,swi_isSetUp.u1); // shiyab added 190320
  connect(isSetUp.y,swi_isSetUp.u2); // shiyab added 190320
  connect(lin.y,swi_isSetUp.u3); // shiyab added 190320
...
/*  connect(TSupWarUpSetBac.y, swi1.u1)
    annotation (Line(points={{41,-120},{68,-120},{68,-42},{78,-42}},
      color={0,0,127})); // shiyab removed 190423 */
  connect(swi_isWarUp.y, swi1.u1); // shiyab added 190423

/*  connect(and2.y, swi2.u2)
    annotation (Line(points={{-19,-50},{18,-50}},color={255,0,255})); // shiyab removed 190320 */
  connect(isCooDow.y, swi2.u2); // shiyab added 190320
...
/*  connect(lin.y, swi2.u3)
    annotation (Line(points={{41,50},{50,50},{50,-30},{8,-30},{8,-58},{18,-58}},
      color={0,0,127})); // shiyab removed 190320 */
  connect(swi_isSetUp.y,swi2.u3); // shiyab added 190320
