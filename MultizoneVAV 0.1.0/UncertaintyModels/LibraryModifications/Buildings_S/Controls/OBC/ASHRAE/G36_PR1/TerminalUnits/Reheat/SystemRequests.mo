within MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.Reheat;
block SystemRequests // _99_01_benchmark
  "Output system requests for VAV reheat terminal unit control"

  parameter Real deltaMovAvg=5*60; // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_TRoo(delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_uCoo(delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_VDis(delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_VDisSet(delta=deltaMovAvg); // shiyab added
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uDam(
    ...
    annotation (Placement(transformation(extent={{-220,-170},{-180,-130}}),
      iconTransformation(extent={{-10,-10},{10,10}},origin={-110,-20})));
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_uDam(delta=deltaMovAvg); // shiyab added
...
//    uLow=cooSetDif_1 - 0.6, // shiyab added
//    uHigh=cooSetDif_1 + 0.6) // shiyab added
//    uLow=cooSetDif_1 - 0.3, // shiyab added
//    uHigh=cooSetDif_1 + 0.3) // shiyab added
...
/*  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu
    ...
    annotation (Placement(transformation(extent={{-60,-50},{-40,-30}}))); // shiyab removed */

/*  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu1
    "Check if discharge airflow is less than 70% of setpoint"
    annotation (Placement(transformation(extent={{-60,-110},{-40,-90}}))); // shiyab removed */

  constant Real conv_cfm_m3s=1./(35.3147*60); // shiyab added
  parameter Modelica.SIunits.VolumeFlowRate vA_halThr = 10*conv_cfm_m3s; // shiyab added
  Modelica.Blocks.Sources.Constant vA_halThr_s(k=vA_halThr); // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.Add add_uHigh_50; // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.Add add_uLow_50(k2=-1); // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu_uHigh_50; // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu_uLow_50; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.Not isNot_50; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.Latch latch_50; // shiyab added

  Buildings.Controls.OBC.CDL.Continuous.Add add_uHigh_70; // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.Add add_uLow_70(k2=-1); // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu_uHigh_70; // shiyab added
  Buildings.Controls.OBC.CDL.Continuous.GreaterEqual greEqu_uLow_70; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.Not isNot_70; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.Latch latch_70; // shiyab added

  Buildings.Controls.OBC.CDL.Interfaces.RealInput tNexNonOcc;
  Modelica.Blocks.Logical.LessEqualThreshold lesEquUno(threshold=10*60);
  Buildings.Controls.OBC.CDL.Logical.Switch swi11;

  Buildings.Controls.OBC.CDL.Logical.Or or_unOcclesEquUno;
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput isUnOcc;

equation
  connect(gai1.y,add_uHigh_50.u1); // shiyab added
  connect(vA_halThr_s.y,add_uHigh_50.u2); // shiyab added
  connect(gai1.y,add_uLow_50.u1); // shiyab added
  connect(vA_halThr_s.y,add_uLow_50.u2); // shiyab added
  connect(add_uHigh_50.y,greEqu_uHigh_50.u1); // shiyab added
  connect(sampler1.y,greEqu_uHigh_50.u2); // shiyab added
  connect(greEqu_uHigh_50.y, isNot_50.u); // shiyab added
  connect(add_uLow_50.y,greEqu_uLow_50.u1); // shiyab added
  connect(sampler1.y,greEqu_uLow_50.u2); // shiyab added
  connect(greEqu_uLow_50.y,latch_50.u); // shiyab added
  connect(isNot_50.y,latch_50.u0); // shiyab added
  connect(latch_50.y,and3.u2); // shiyab added

  connect(gai2.y,add_uHigh_70.u1); // shiyab added
  connect(vA_halThr_s.y,add_uHigh_70.u2); // shiyab added
  connect(gai2.y,add_uLow_70.u1); // shiyab added
  connect(vA_halThr_s.y,add_uLow_70.u2); // shiyab added
  connect(add_uHigh_70.y,greEqu_uHigh_70.u1); // shiyab added
  connect(sampler1.y,greEqu_uHigh_70.u2); // shiyab added
  connect(greEqu_uHigh_70.y, isNot_70.u); // shiyab added
  connect(add_uLow_70.y,greEqu_uLow_70.u1); // shiyab added
  connect(sampler1.y,greEqu_uLow_70.u2); // shiyab added
  connect(greEqu_uLow_70.y,latch_70.u); // shiyab added
  connect(isNot_70.y,latch_70.u0); // shiyab added
  connect(latch_70.y, and4.u2); // shiyab added

  connect(tNexNonOcc,lesEquUno.u); // shiyab added
  connect(isUnOcc,or_unOcclesEquUno.u1); // shiyab added
  connect(lesEquUno.y,or_unOcclesEquUno.u2); // shiyab added
  connect(zerPreResReq.y,swi11.u1); // shiyab added
  connect(or_unOcclesEquUno.y,swi11.u2); // shiyab added
  connect(swi4.y,swi11.u3); // shiyab added
  connect(swi11.y,reaToInt1.u); // shiyab added
...
/*  connect(swi4.y, reaToInt1.u)
    annotation (Line(points={{121,-40},{138,-40}}, color={0,0,127})); // shiyab removed */
...
/*  connect(sampler.u, VDisSet)
    annotation (Line(points={{-162,-40},{-170,-40},{-170,30},{-200,30}},
                                                   color={0,0,127})); // shiyab removed */
  connect(movAvg_VDisSet.y,sampler.u); // shiyab added
...
/*  connect(sampler1.u, VDis)
    annotation (Line(points={{-162,-70},{-200,-70}}, color={0,0,127})); // shiyab removed */
  connect(VDis,movAvg_VDis.u); // shiyab added
  connect(movAvg_VDis.y,sampler1.u); // shiyab added
/*  connect(uDam, sampler2.u)
    annotation (Line(points={{-200,-150},{-162,-150}}, color={0,0,127})); // shiyab removed */
  connect(uDam,movAvg_uDam.u); // shiyab added
  connect(movAvg_uDam.y,sampler2.u); // shiyab added
  connect(sampler2.y, hys4.u)
    annotation (Line(points={{-139,-150},{-62,-150}},  color={0,0,127}));
/*  connect(uCoo, sampler4.u)
    annotation (Line(points={{-200,90},{-162,90}}, color={0,0,127})); // shiyab removed */
  connect(uCoo,movAvg_uCoo.u); // shiyab added
  connect(movAvg_uCoo.y,sampler4.u); // shiyab added
...
/*  connect(hys7.u, VDisSet)
    annotation (Line(points={{-62,30},{-200,30}}, color={0,0,127})); // shiyab removed */
  connect(VDisSet,movAvg_VDisSet.u); // shiyab added
  connect(movAvg_VDisSet.y,hys7.u); // shiyab added
/*  connect(add2.u2, TRoo) annotation (Line(points={{-102,194},{-150,194},{-150,170},
          {-200,170}}, color={0,0,127})); // shiyab removed */
  connect(TRoo,movAvg_TRoo.u); // shiyab added
  connect(movAvg_TRoo.y,add2.u2); // shiyab added

/*  connect(add3.u2, TRoo) annotation (Line(points={{-102,134},{-150,134},{-150,170},
          {-200,170}}, color={0,0,127})); // shiyab removed */
  connect(movAvg_TRoo.y,add3.u2); // shiyab added
...
/*  connect(greEqu.u1, gai1.y)
  ...
  connect(greEqu1.y, and4.u2) annotation (Line(points={{-39,-100},{0,-100},{0,-108},
          {38,-108}}, color={255,0,255}));// shiyab removed */
annotation (
