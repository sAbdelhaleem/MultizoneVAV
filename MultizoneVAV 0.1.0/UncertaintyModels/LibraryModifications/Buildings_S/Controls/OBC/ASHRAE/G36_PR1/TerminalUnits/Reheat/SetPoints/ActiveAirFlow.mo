...
block ActiveAirFlow // _99_03_benchmark
  "Output the active airflow setpoint for VAV reheat terminal unit"

  Buildings.Controls.OBC.CDL.Logical.Or or2_S; // shiyab added 190326
  Buildings.Controls.OBC.CDL.Logical.Or or3_S; // shiyab added 190326
  Buildings.Controls.OBC.CDL.Logical.Or or_S; // shiyab added 190326
  Buildings.Controls.OBC.CDL.Logical.Switch swi29; // shiyab added 190326
  Buildings.Controls.OBC.CDL.Logical.Switch swi30; // shiyab added 190326
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant minZonAir_nightSetBac(final k=VMin*.75); // shiyab added 190326
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant minZonAir_nightSetBac2(final k=VMin*.75); // shiyab added 190326
...
/*  Buildings.Controls.OBC.CDL.Continuous.MultiSum actCooMinAir(nin=1)
    ...
    annotation (Placement(transformation(extent={{220,130},{240,150}}))); // shiyab removed 190326 */
  Buildings.Controls.OBC.CDL.Continuous.MultiSum actCooMinAir(nin=3); // shiyab added 190326

/*  Buildings.Controls.OBC.CDL.Continuous.MultiSum actMinAir(nin=1)
    "Active minimum airflow"
    annotation (Placement(transformation(extent={{220,100},{240,120}}))); // shiyab removed 190326 */
  Buildings.Controls.OBC.CDL.Continuous.MultiSum actMinAir(nin=2);
...
/*  Buildings.Controls.OBC.CDL.Continuous.MultiSum actHeaMaxAir(nin=4)
  "Active heating maximum airflow"
    annotation (Placement(transformation(extent={{220,20},{240,40}}))); // shiyab removed 190326 */
  Buildings.Controls.OBC.CDL.Continuous.MultiSum actHeaMaxAir(nin=3); // shiyab added 190326

  Buildings.Controls.OBC.CDL.Continuous.Max maxInp "Find greater input"
    annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));

equation
  connect(intEqu2.y,or2_S.u1); // shiyab added 190326
  connect(intEqu4.y,or2_S.u2); // shiyab added 190326
  connect(intEqu1.y,or3_S.u1); // shiyab added 190326
  connect(intEqu3.y,or3_S.u2); // shiyab added 190326
  connect(or3_S.y,or_S.u1); // shiyab added 190326
  connect(or2_S.y,or_S.u2); // shiyab added 190326

  connect(minZonAir_nightSetBac.y, swi29.u1); // shiyab added
  connect(intEqu2.y, swi29.u2); // shiyab added
  connect(zerCon6.y, swi29.u3); // shiyab added
  connect(swi29.y, actCooMinAir.u[2]); // shiyab added

  connect(minZonAir_nightSetBac2.y, swi30.u1); // shiyab added
  connect(or_S.y, swi30.u2); // shiyab added
  connect(zerCon6.y, swi30.u3); // shiyab added
  connect(swi30.y, actMinAir.u[2]); // shiyab added
...
/*  connect(heaMaxAir.y, swi8.u1)
    annotation (Line(points={{-159,-10},{-134,-10},{-134,278},{-102,278}},
      color={0,0,127})); // shiyab removed 190326 */
  connect(minZonAir_nightSetBac.y, swi8.u1); // shiyab added 190326

/*  connect(intEqu1.y, swi4.u2)
    annotation (Line(points={{-159,300},{-102,300}}, color={255,0,255})); // shiyab removed 190514 */
  connect(or3_S.y, swi4.u2); // shiyab added 190514
  connect(or3_S.y, swi8.u2)
  ...
  connect(zerCon6.y, swi9.u3)
    annotation (Line(points={{-219,180},{-120,180},{-120,222},{-102,222}},
      color={0,0,127}));
  connect(or3_S.y, swi17.u2)
    annotation (Line(points={{61,300},{118,300}},
      color={255,0,255}));
  connect(or3_S.y, swi18.u2)
...
/*  connect(heaMaxAir.y, swi17.u1)
    annotation (Line(points={{-159,-10},{-134,-10},{-134,10},{86,10},{86,308},
      {118,308}}, color={0,0,127})); // shiyab removed 190326 */
  connect(minZonAir_nightSetBac.y, swi17.u1); // shiyab added 190326

  connect(cooMaxAir.y, swi18.u1)
    annotation (Line(points={{-219,-10},{-204,-10},{-204,16},{80,16},{80,278},
      {118,278}}, color={0,0,127}));
//  connect(heaMaxAir.y, swi18.u1); // shiyab added 190326
...
/*  connect(heaMaxAir.y, swi22.u1)
    annotation (Line(points={{-159,-10},{-134,-10},{-134,10},{86,10},{86,238},
      {118,238}}, color={0,0,127})); // shiyab removed 190326 */
  connect(minZonAir_nightSetBac.y, swi22.u1); // shiyab added 190326

/*  connect(cooMaxAir.y, swi23.u1)
    annotation (Line(points={{-219,-10},{-204,-10},{-204,16},{80,16},{80,208},
      {118,208}}, color={0,0,127})); // shiyab removed 190326 */
  connect(heaMaxAir.y, swi23.u1); // shiyab added 190326
...
/*  connect(swi8.y, actHeaMaxAir.u[2])
    annotation (Line(points={{-79,270},{-44,270},{-44,31.75},{218,31.75}},
      color={0,0,127})); // shiyab removed 190326 */
  connect(swi8.y, actCooMinAir.u[3]); // shiyab added 190326
...
/*  connect(swi18.y, actHeaMaxAir.u[3])
    annotation (Line(points={{141,270},{190,270},{190,28.25},{218,28.25}},
      color={0,0,127})); // shiyab removed 190326 */
  connect(swi18.y, actHeaMaxAir.u[2]); // shiyab added 190326
...
/*  connect(swi23.y, actHeaMaxAir.u[4])
    annotation (Line(points={{141,200},{168,200},{168,24.75},{218,24.75}},
      color={0,0,127})); // shiyab removed 190326 */
  connect(swi23.y, actHeaMaxAir.u[3]); // shiyab added 190326
