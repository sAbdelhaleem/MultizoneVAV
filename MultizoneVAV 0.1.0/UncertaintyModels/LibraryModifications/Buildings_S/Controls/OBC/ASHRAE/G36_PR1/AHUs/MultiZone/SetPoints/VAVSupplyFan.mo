...
block VAVSupplyFan  "Block to control multi zone VAV AHU supply fan" // _99_01_benchmark

//  Modelica.Blocks.Interfaces.BooleanInput conSpeTri; // shiyab added
...
equation
//  connect(conSpeTri,conSpe.trigger); // shiyab added
