within MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints;
block OperationMode "Block that outputs the operation mode" // _99_01_benchmark
  ...
  Buildings.Controls.OBC.CDL.Continuous.MovingMean movAvg_TZon[numZon](each delta=deltaMovAvg); // shiyab added
...
//    uLow=-0.5*bouLim,
    uLow=-0.65*bouLim,
//    uHigh=0.5*bouLim, // shiyab removed
//    uLow=-0.25,
    uHigh=0.1, // shiyab added
    pre_y_start=false)
...
//    uLow=-0.55, // shiyab added
//    uHigh=0.55) // shiyab added
//    uLow=-0.3, // shiyab added
//    uHigh=0.3) // shiyab added
...
//    annotation (Placement(transformation(extent={{200,140},{220,160}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.And3 and1; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.And and1_notSetBack; // shiyab added

  Buildings.Controls.OBC.CDL.Logical.Not not_CooDow; // shiyab added
  Buildings.Controls.OBC.CDL.Logical.Not not_SetBack; // shiyab added
...
/*  connect(TZon, swi1.u3)
  ...
  connect(movAvg_TZon.y, swi1.u3); // shiyab added
...
/*  connect(TZon, swi2.u3)
    annotation (Line(points={{-280,-10},{-240,-10},{-240,-202},{-202,-202}},
      color={0,0,127})); // shiyab removed */
  connect(movAvg_TZon.y, swi2.u3); // shiyab added
...
/*  connect(lat1.y, booToRea4.u)
    annotation (Line(points={{161,-110},{198,-110}}, color={255,0,255})); // shiyab removed */
  connect(and1_notSetBack.y, booToRea4.u); // shiyab added
...
/*  connect(lat1.y, or5.u2)
    annotation (Line(points={{161,-110},{180,-110},{180,-150},{120,-150},
      {120,-310},{138,-310}}, color={255,0,255})); // shiyab removed */

  connect(and1_notSetBack.y, or5.u2); // shiyab added
...
/*  connect(maxZonTem.yMax, addPar.u)
    annotation (Line(points={{-119,-90},{-40,-90},{-40,-110},{-2,-110}},
      color={0,0,127})); // shiyab removed */
  connect(minZonTem.yMin, addPar.u); // shiyab added

  connect(maxZonTem.yMax, add1.u1)
    annotation (Line(points={{-119,-90},{-40,-90},{-40,-264},{78,-264}},
      color={0,0,127}));
//  connect(minZonTem.yMin, add1.u1); // shiyab added

/*  connect(TZon, maxZonTem.u)
    annotation (Line(points={{-280,-10},{-240,-10},{-240,-90},{-142,-90}},
      color={0,0,127})); // shiyab removed */
  connect(TZon[1],movAvg_TZon[1].u); // shiyab added
  connect(TZon[2],movAvg_TZon[2].u); // shiyab added
  connect(movAvg_TZon.y,maxZonTem.u); // shiyab added

/*  connect(TZon,minZonTem.u)
    annotation (Line(points={{-280,-10},{-240,-10},{-240,-120},{-142,-120}},
      color={0,0,127})); // shiyab removed */
  connect(movAvg_TZon.y,minZonTem.u); // shiyab added
  ...
  connect(minZonTem.yMin, add2.u2)
    annotation (Line(points={{-119,-120},{-98,-120},{-98,-76},{78,-76}},
      color={0,0,127}));
//  connect(maxZonTem.yMax, add2.u2); // shiyab added
  ...
  connect(and2.y,not_CooDow.u); // shiyab added
  connect(not_CooDow.y,and1.u3); // shiyab added
...
/*  connect(lat1.y, not5.u)
    annotation (Line(points={{161,-110},{180,-110},{180,-150},{198,-150}},
      color={255,0,255})); // shiyab removed */
  connect(and1_notSetBack.y, not5.u); // shiyab added

  connect(not5.y, assMes.u)
    annotation (Line(points={{221,-150},{258,-150}}, color={255,0,255}));

  connect(lat.y,not_SetBack.u); // shiyab added
  connect(lat1.y,and1_notSetBack.u1); // shiyab added
  connect(not_SetBack.y,and1_notSetBack.u2); // shiyab added
