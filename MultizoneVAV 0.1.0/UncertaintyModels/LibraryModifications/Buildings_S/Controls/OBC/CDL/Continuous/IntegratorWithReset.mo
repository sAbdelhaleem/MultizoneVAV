...
block IntegratorWithReset "Output the integral of the input signal" // _99_01_benchmark
...
/*  parameter Real k(unit="1")=1 "Integrator gain"; // shiyab removed */
  Real k(unit="1")=1 "Integrator gain"; // shiyab added
...
/*  parameter Real y_reset = 0
    ...
    annotation(Dialog(
                 ...
                 group="Integrator reset")); // shiyab removed */

  Real y_reset = 0 // shiyab added
    "Value to which integrator is reset, used if reset = Types.Reset.Parameter"; // shiyab added
