within MultizoneVAV.UncertaintyModels.LibraryModifications.Buildings_S.Controls.OBC.CDL.Routing;
block ExtractSignal "Extract signals from an input signal vector" // _99_01_benchmark
  parameter Integer nin = 1 "Number of inputs";
  parameter Integer nout = 1 "Number of outputs";
/*  parameter Integer extract[nout]=1:nout "Extracting vector"; // shiyab removed */
  Integer extract[nout]=1:nout "Extracting vector"; // shiyab added
  Modelica.Blocks.Interfaces.RealInput u[nin] "Connector of Real input signal"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  Modelica.Blocks.Interfaces.RealOutput y[nout] "Connector of Real output signal"
