...
model Guideline36_SimulationCrashChallenge5 // _99_07_benchmarkwoTMixNoise
  "Variable air volume flow system with terminal reheat and two thermal zones"
  extends MultizoneVAV.UncertaintyModels.VAVReheat.BaseClasses.PartialOpenLoop_SimulationCrashChallenge5;
...
end Guideline36_SimulationCrashChallenge5;
