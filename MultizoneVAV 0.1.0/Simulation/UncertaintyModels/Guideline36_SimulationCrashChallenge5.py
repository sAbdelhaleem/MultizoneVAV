...
fmu_name = compile_fmu("MultizoneVAV.UncertaintyModels.VAVReheat.Guideline36_SimulationCrashChallenge5", jvm_args='-Xmx4g', compiler_options={"generate_html_diagnostics":True},compiler_log_level='error')
